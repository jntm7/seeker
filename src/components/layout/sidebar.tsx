          ...
          <aside className="absolute inset-y-0 left-0 z-50 flex w-44 flex-col border-r bg-background">
            <div className="flex h-14 items-center justify-between px-4">
              ...
              <button
                ...
                className="flex h-6 w-6 items-center justify-center rounded-md text-muted-foreground hover:text-purple-600 hover:bg-purple-50 dark:hover:text-purple-300 dark:hover:bg-purple-900/20 transition-colors"
              >
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : "text-muted-foreground hover:text-purple-600 hover:bg-purple-50 dark:hover:text-purple-300 dark:hover:bg-purple-900/20"
                    )}
                  >
            ...
            <div className="border-t p-2 flex flex-col gap-0">
              ...
              <button
                type="button"
                onClick={toggleTheme}
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors w-full text-muted-foreground hover:text-purple-600 hover:bg-purple-50 dark:hover:text-purple-300 dark:hover:bg-purple-900/20"
              >
      ...
      >
        <button
          ...
          onClick={() => setCollapsed(!collapsed)}
           className="absolute -right-2.5 top-[44px] z-10 flex h-6 w-5 items-center justify-center rounded-md border bg-background text-muted-foreground hover:text-purple-600 dark:hover:text-purple-300 transition-colors"
